...
chessboardSize = (11, 12)  # x,y
frameSize = (640, 480)  # 1280x642
...
objp = objp * 40  # todo size of fields in chessboard
...
for imgLeft, imgRight in zip(imagesLeft, imagesRight):
    ...
    print('Resized Dimensions : ', imgL.shape)

    print('Resized Dimensions : ', imgR.shape)
    ...
    # Find the chess board corners. Corners stored in cornersL/R
...
# Combine individual camera calibrations: get the essential and fundamental matrix.
# i.e. how one image is related to the other image
...
# All information stored in newCameraMatrix
...
# Parameters to be stored for further use
