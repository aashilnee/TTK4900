...
def parse_args():
  ...
  parser.add_argument('--lr_decay_step', dest='lr_decay_step',
                      ...
                      default=10, type=int)  # TODO ENDRE DENNE
      ...
      for i, row in enumerate(csv_reader):
        if row[5] != '{}' and i > 0:
          ...
          if attributes_dict['name'] == 'roi':
            ...
            #print("TEST", str(l_rois))
            #print("TEST2", str(r_rois))
...
if __name__ == '__main__':
 ...
 # imdb, roidb, ratio_list, ratio_index = combined_roidb('kitti_train')
  ...
  #print('{:d} roidb entries'.formatrain_size))
  ...
  train_dir = "data/training_data/" # dataset path
  ...
  for epoch in range(0, args.max_epochs + 1):
    ...
    for step, data in enumerate(dataloader):
      ...
      # TODO TEST LOSS UTEN DIM OG KPTS
      #RCNN_loss_dim_orien.mean = None
      #RCNN_loss_kpts.mean = None

      #RCNN_loss_dim_orien.assign([[0]])
     ...
     # v.assign([[1.]])
      ...
      #print("clip", clip_gradient(stereoRCNN, 10.))
