...
class StereoManager:
    ...
    def stereopixel_to_real(self, left_xy, right_xy):
        ...
        #print("undist_right: ", undist_right)
        #print("undist_left: ", undist_left)
        ...
        #print("disparity values: ", disparity_values)
        ...
        return real_points, disparity_values # TODO HAR LAGT TIL DISPARITY POINTS
    ...
    def evaluate_calibration(self, dir_path: str, board_params: tuple):
        ...
        for i, fname in enumerate(images_right):
            ...
            # cv2.imread(gray_l)
            #cv2.imshow("im", gray_l)
            #cv2.waitKey(1)

            #rect_gray_l, rect_gray_r = self.rectify_images(gray_l, gray_r)  # todo
            rect_gray_r, rect_gray_l = calibration.undistortRectify(gray_r, gray_l)

            # TODO
            # cv2.imread(rect_gray_l)
            #cv2.imshow("imm", rect_gray_l)
            # cv2.waitKey(0)
...
def main():
    stereoMap_path = "/Users/aashi/Documents/stereoMaps"
    img_path = "/Users/aashi/Documents/chess_frames_padding/"

    board_data = (11, 12, 40) # todo board data: Board real life measurements (Number of squares x, Number of squares y, Square length)
