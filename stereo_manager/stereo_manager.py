...
class StereoManager:
    ...
    def calibrate_from_dir(self, dir_path: str, board_params: tuple):
        ...
        for file in os.listdir(dir_path):
            ...
            resize = cv2.resize(img, down_points, interpolation=cv2.INTER_AREA)
...
def main():
    img_path = "/Users/aashi/Documents/chess_frames_copy_copy_copy/"
    export_path = "/Users/aashi/Documents/"
    ...
    stereo_manager.load_calibration(os.path.join(export_path, "stereo_calibration.pickle")) # 2_stereo_calibration.pickle
